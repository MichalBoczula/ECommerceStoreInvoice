...
{
    [Binding]
    public sealed class GetInvoiceByIdNotFoundSteps
    {
        private readonly ScenarioApiContext _apiContext;
        private Guid _invoiceId;

        public GetInvoiceByIdNotFoundSteps(ScenarioApiContext apiContext)
        {
        ...
        public async Task WhenIRequestInvoiceByIdForNonExistingInvoice()
        {
        ...
        public async Task ThenProblemDetailsAreReturnedForGetInvoiceByIdNotFound(Table table)
        {
            ...
            if (TryGetBool(expected, "HasDetail", out var hasDetail))
            {
                if (hasDetail)
                {
                    ...
                    problemDetails.Detail.ShouldContain("Invoice", Case.Insensitive);
                }
                else
                {
